...
public class Collections3 {
     ...
     * @return
     */
    public static List<Integer> convertToList(final String str,final String separatorChar){

        String [] splits = StringUtils.split(str,separatorChar);
     ...
     * @param str
     */
    public static List<Integer> convertToList(final String str){
